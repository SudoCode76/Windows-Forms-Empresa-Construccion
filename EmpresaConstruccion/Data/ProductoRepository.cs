...
namespace EmpresaConstruccion.Data
{
    public class ProductoRepository
    {
        ...
        public List<Models.Producto> GetAll()
        {
            ...
            {
                // Manejo de error: podrías registrar el error o lanzar una excepción personalizada
        ...
        public void Add(Models.Producto producto)
        {
            ...
            {
                throw new ApplicationException("Error al agregar producto.", ex);
            }
        }
        ...
        public void Update(Models.Producto producto)
        {
            ...
            {
                throw new ApplicationException("Error al actualizar producto.", ex);
            }
        }
        ...
        public void Delete(int idProducto)
        {
            ...
            {
                throw new ApplicationException("Error al eliminar producto.", ex);
            }
        }
    }
}